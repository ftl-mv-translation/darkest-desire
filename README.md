# Darkest Desire Translation Project

## Link to the latest nightly translation

Download from [HERE](https://github.com/ftl-mv-translation/darkest-desire/releases/latest). (Updated every UTC 00:00)
...
1. Unzip the latest DD into src-en/ directory
